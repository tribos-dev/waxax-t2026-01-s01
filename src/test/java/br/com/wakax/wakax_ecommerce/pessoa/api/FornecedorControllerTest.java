...
class FornecedorControllerTest {
  ...
  void deveAtualizarFornecedorComSucesso() {
    ...
    when(fornecedorService.atualizarFornecedor(fornecedorId, request)).thenReturn(responseMock);
    ...
    verify(fornecedorService, times(1)).atualizarFornecedor(fornecedorId, request);
  }
  ...
  void deveLancarExcecaoAoAtualizarQuandoFornecedorNaoEncontrado() {
    ...
    when(fornecedorService.atualizarFornecedor(fornecedorId, request)).thenThrow(exception);
  ...
  void deveFalharQuandoEmailsForemNulos() {
    ...
    FornecedorAtualizaRequest requestInvalido =
        new FornecedorAtualizaRequest(
            null,
            List.of("11999999999"),
            List.of(mockEndereco()),
