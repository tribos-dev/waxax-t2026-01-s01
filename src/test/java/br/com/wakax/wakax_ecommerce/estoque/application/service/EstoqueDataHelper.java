...
public class EstoqueDataHelper {
  ...
  public static Produto criarProdutoComPreco(String descricao, BigDecimal precoVenda) {
    ...
    Preco preco = Preco.builder().valor(precoVenda).produto(produto).build();
  ...
  public static List<Estoque> listaEstoquePadrao() {
    return List.of(
        criarEstoque("Mouse", 5, "10.00", "50.00"), criarEstoque("Notebook", 2, "20.00", "40.00"));
  }

  private static Estoque criarEstoque(
      String descricao, int qtd, String custoMedio, String custoTotal) {
  ...
  public static AdicionaQuantidadeRequest criaRequest() {
    ...
    public static AdicionaQuantidadeRequest criaRequestInvalido() {
        return AdicionaQuantidadeRequest.builder()
                .quantidade(-5)
                .custoUnitario(BigDecimal.valueOf(60.00))
                .build();
