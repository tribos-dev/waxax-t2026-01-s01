...
public class ProdutoListagemResponse {
    ...
    public static ProdutoListagemResponse converte(List<Produto> produtos) {
        List<ProdutoItem> produtosOrdenados = produtos.stream()
                .map(ProdutoItem::new)
    ...
    public static ProdutoListagemResponse convertePaginado(List<Produto> produtos, long totalElementos) {
        List<ProdutoItem> produtosConvertidos = produtos.stream()
                .map(ProdutoItem::new)
                .toList();
