...
public class FornecedorAtualizaRequest {
  ...
  private List<
          ...
          @javax.validation.constraints.Email(message = "{validacao.email.formato}") String>
      emails;

  @NotNull(message = "{validacao.emails.obrigatorio}")
  @NotEmpty(message = "{validacao.telefone.obrigatorio}")
  private List<
          @NotBlank(message = "{validacao.telefone.obrigatorio}") @NotEmpty
          @Size(max = 20, message = "{validacao.telefone.tamanho}")
          @javax.validation.constraints.Pattern(
              regexp = "\\d{10,11}",
              message = "{validacao.telefone.formato}")
          String>
      telefones;
