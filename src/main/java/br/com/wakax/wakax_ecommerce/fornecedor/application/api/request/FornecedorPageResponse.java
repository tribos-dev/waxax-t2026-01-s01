...
import br.com.wakax.wakax_ecommerce.fornecedor.application.api.response.FornecedorResumoResponse;
...
public class FornecedorPageResponse {
    ...
    public FornecedorPageResponse(Page<Fornecedor> page) {
        this.fornecedores = page.getContent()
                .stream()
                .map(FornecedorResumoResponse::new)
                .toList();
